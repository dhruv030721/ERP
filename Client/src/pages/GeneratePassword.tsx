            ...
            <div className="min-h-screen flex flex-col">
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-4">
                    <div className="text-center max-w-md mx-auto p-8 rounded-lg bg-gray-50 border">
                        ...
                        <button
                            onClick={() => navigate('/')}
                            className="bg-orange-500 rounded-md font-poppins text-white py-3 px-6  hover:bg-orange-600 transition-colors duration-200"
                        >
                            Back to Home
                        </button>
                    </div>
            ...
            <div className="flex-1 flex flex-col font-poppins items-center p-4 md:p-8">
                <div className="w-full max-w-md mx-auto">
                    ...
                    >
                        ...
                        <button
                            className="bg-orange-500 rounded-md py-3 text-white w-full mt-4 hover:bg-orange-600 transition-colors duration-200"
                            type="submit"
                        >
                            Generate Password
                        </button>
