...
import App from './App'
import { Dashboard, Switchboard, Login, AddStudent, MarkAttendance, AttendanceReport, Subject, AddFaculty, GeneratePassword, AssignSubject, ManageTimetable, ForgotPassword, PageNotFound } from './pages'
